 ...
 * @author Kartik Kumar
 */
public class TestNGAssertsTest extends TestCase {
  ...
  public void testNotEqualFailure() throws Exception {
    try {
      ...
      Assert.assertEquals("expected not to be <1>", ae.getMessage());
    }
  }
  ...
  public void testNotEqualNullFailure() throws Exception {
    try {
      ...
      Assert.assertEquals("expected not to be <null>", ae.getMessage());
    }
  }
